...
const Profile = () => {
    ...
    return (<SafeAreaView className=" flex-1 bg-[#FFEFE0]">
            ...
            <View className="flex-row items-center bg-white mx-4 rounded-3xl py-1 px-4 shadow-lg mb-4 min-h-[90px]">
                ...
                <View>
                    <Text className="text-lg text-gray-800">
                        Số Egg Points hiện tại của bạn </Text>
        ...
        <View className="flex-1 items-center">
            ...
            // contentContainerStyle={{justifyContent: 'center', alignItems: 'center', marginTop: 8 }}
        /></View>
